...
/// <summary>
/// Creates unbounded prioritized mailbox channels for actor message processing.
/// </summary>
public sealed class UnboundedPrioritizedMailboxProvider
    : IMailboxProvider
{
    /// <summary>
    ...
    {
        return Channel.CreateUnboundedPrioritized<TMessage>(
            new()
            {
